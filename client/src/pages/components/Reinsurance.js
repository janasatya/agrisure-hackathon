...
export default function Reinsurance({ setSelect, webApi }) {
  ...
  return (
    <div className=" w-2/3 m-auto">
      ...
      <button
        className="w-full border-2 border-black m-auto block p-2  rounded-md text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 text-xl"
        onClick={() => {
          setSelect(0);
        }}
      >
